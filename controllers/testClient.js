...
//==============================================================
var connectClient = function aysnc ()
{
...
//==============================================================
var readModbusData = function aysnc ()
{
    // try to read data
...
//==============================================================
var writeModbusData = function aysnc (registerAdd,val)
{
    // try to read data
    client.writeRegister (0, 9873)
        .then(function(data)
        {
            mbsState   = MBS_STATE_GOOD_READ;
            mbsStatus  = "success";
...
var runModbus = function async ()
{
    ...
    client.writeRegisters(2,[1,2,3,2,1]);
